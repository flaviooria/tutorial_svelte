<script>
    // Trabajaremos la reactividad, donde tocaremos 4 puntos 
    /**
     * Asignación reactiva
     * Declarión reactiva
     * Sentencias
    ...
    function incrementCount() {
		// Manejaremos la reactividad que tiene svelte donde manipula directamente el dom, con nuestra variable declarada previamente
